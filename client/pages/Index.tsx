...
export default function Index() {
  ...
  const collections = [
    {
      title: "Diamond Rings",
      description:
        "Exquisite diamond rings crafted with precision and elegance for your special moments.",
      image:
    ...
    },
    {
      ...
      description:
        "Traditional and contemporary gold necklace designs that showcase timeless beauty.",
      image:
    ...
    },
    {
      ...
      description:
        "Complete bridal jewelry sets designed to make your wedding day truly memorable.",
      image:
        "https://images.unsplash.com/photo-1596944924591-79b9a2c2c77e?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    },
    {
      title: "Precious Gemstones",
      description:
        "Rare and beautiful gemstone jewelry featuring sapphires, emeralds, and rubies.",
      image:
        "https://images.unsplash.com/photo-1606318801954-d46d46d3360a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      designation: "Bride",
      content:
        "Hassan Jewellers made my wedding day absolutely magical with their stunning bridal collection. The quality and craftsmanship are unmatched!",
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b612e829?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80",
    },
    {
      name: "Raj Patel",
      designation: "Business Owner",
      content:
        "I've been a customer for over 10 years. Their collection keeps getting better, and the service is always exceptional.",
      rating: 5,
      image:
    ...
    },
    {
      ...
      content:
        "The attention to detail in every piece is remarkable. Hassan Jewellers understands luxury like no other.",
      rating: 5,
      image:
    ...
    },
    {
      ...
      designation: "Groom",
      content:
        "Found the perfect engagement ring here. The staff was incredibly helpful and the quality exceeded expectations.",
      rating: 5,
      image:
    ...
    },
    {
      ...
      content:
        "Their heritage collection is absolutely breathtaking. Each piece tells a beautiful story of craftsmanship.",
      rating: 5,
      image:
  ...
  return (
    <div className="relative min-h-screen bg-luxury-pearl dark:bg-luxury-rich-black">
        ...
        <div className="h-screen flex items-center justify-center relative overflow-hidden">
          <div className="relative z-20 text-center px-4 max-w-7xl mx-auto">
            ...
            >
              ...
              celebrate life's precious moments. Experience luxury, tradition,
            ...
            >
              ...
              <AnimatedButton variant="outline">View Gallery</AnimatedButton>
            </motion.div>
          </div>
        </div>
      </AuroraBackground>
      ...
      <section
        id="about"
        className="py-20 px-4 bg-white dark:bg-luxury-rich-black relative"
      >
        <BackgroundBeams />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
                For over three decades, Hassan Jewellers has been synonymous
                with exceptional craftsmanship, timeless designs, and
                unparalleled quality. Our master artisans blend traditional
                techniques with contemporary aesthetics to create jewelry that
                tells your unique story.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
                From engagement rings that symbolize eternal love to heritage
                pieces that celebrate tradition, every creation at Hassan
                Jewellers is crafted with passion, precision, and an unwavering
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Experience the convenience of having exquisite jewelry delivered
              right to your doorstep, anywhere across India with our secure and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                tooltip:
                  "Your jewelry is protected with full insurance coverage",
              },
              {
              ...
              },
              {
                ...
                tooltip:
                  "Every piece comes with official authenticity certificates",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section
        id="collections"
        className="py-20 px-4 bg-white dark:bg-luxury-rich-black"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Discover our curated collection of fine jewelry, each piece
              telling a story of elegance, tradition, and exceptional
              craftsmanship.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-luxury-pearl to-white dark:from-luxury-rich-black dark:to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <ColorfulText animationType="glow">Customer Reviews</ColorfulText>
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Hear what our valued customers say about their experience with
              Hassan Jewellers. Your satisfaction is our greatest achievement.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-white dark:bg-luxury-rich-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <ColorfulText animationType="wave">Our Showroom</ColorfulText>
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Step into our elegant showroom where luxury meets tradition.
              Experience our collections in a sophisticated environment designed
              for your comfort.
            </p>
          </motion.div>
      ...
      <section
        id="contact"
        className="py-20 px-4 bg-gradient-to-br from-luxury-pearl to-white dark:from-luxury-rich-black dark:to-gray-900 relative"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <ColorfulText animationType="rainbow">Get In Touch</ColorfulText>
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              <CardSpotlight className="h-full">
                ...
                <div className="space-y-6">
                  {[
                    {
                      icon: (
                        <FaMapMarkerAlt className="text-gold-500 text-xl mt-1" />
                      ),
                      title: "Address",
                      content:
                        "72/843 Madurai Ismail Saheb Street\nVaniyambadi, Tamil Nadu, India 635751",
                    },
                    {
                      icon: <FaPhone className="text-gold-500 text-xl mt-1" />,
                      title: "Phone",
                      content: "+91 97878 12341",
                    },
                    {
                      icon: (
                        <FaEnvelope className="text-gold-500 text-xl mt-1" />
                      ),
                      title: "Email",
                    ...
                    <AnimatedTooltip
                      key={index}
                      content={`Contact us via ${item.title.toLowerCase()}`}
                    >
