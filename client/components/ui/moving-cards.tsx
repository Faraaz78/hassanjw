  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px] bg-gradient-to-br from-gold-50 to-rose-50 dark:from-slate-900 dark:to-slate-800"
            key={idx}
          >
            <blockquote>
              <div
