    ...
    >
      ...
      >
        {testimonials.map((testimonial, idx) => (
          <motion.div
            key={idx}
            className="w-[350px] max-w-full relative rounded-2xl border border-gold-200 dark:border-gold-800 flex-shrink-0 px-8 py-6 bg-gradient-to-br from-luxury-pearl to-white dark:from-luxury-rich-black dark:to-gray-900 shadow-lg"
