...
export const CardSpotlight = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        "relative group/spotlight rounded-xl bg-gradient-to-br from-luxury-pearl to-white dark:from-black dark:to-black border border-gold-200 dark:border-gold-600 p-6 shadow-lg overflow-hidden",
        className
      )}
      style={{
        rotateX,
