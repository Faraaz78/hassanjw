...
export const BackgroundBeams = ({ className }: { className?: string }) => {
  ...
  // Deterministic delays to prevent hydration mismatch
  ...
  return (
    <div
      className={cn(
        "absolute left-0 top-0 h-full w-full overflow-hidden bg-gradient-to-br from-white via-luxury-pearl to-gray-50 dark:bg-gradient-to-br dark:from-black dark:via-black dark:to-black",
        className
      )}
    >
      <svg
