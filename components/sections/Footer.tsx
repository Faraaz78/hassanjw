      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-md">
              For over three decades, we've been crafting timeless elegance with
              exquisite jewelry pieces. Experience luxury, tradition, and
              unmatched craftsmanship at Hassan Jewellers.
            </p>
            <div className="flex space-x-4">
              {[
                ...
                {
                  icon: <FaInstagram />,
                  href: "https://www.instagram.com/hassanjewellers",
                  label: "Instagram",
                },
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl font-semibold mb-6 text-gold-600 dark:text-gold-400">
              Quick Links
            </h3>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    7/843 Madurai Ismail Saheb Street
                    <br />
        ...
        >
          ...
          <div className="flex space-x-6 text-sm">
            <Link
              href="#"
              className="text-gray-500 dark:text-gray-400 hover:text-gold-600 dark:hover:text-gold-400 transition-colors duration-300"
            >
              Privacy Policy
            </Link>
            <Link
