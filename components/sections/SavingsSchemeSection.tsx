...
export const SavingsSchemeSection = () => {
  ...
  const benefits = [
    {
      ...
      description:
        "Buy jewelry with no wastage charges up to 16% on accumulated value",
      icon: "💎",
    },
    {
      title: "12 Month Plan",
    ...
    },
    {
      ...
      description:
        "Starting from Rs. 5,000 monthly - choose what works for you",
      icon: "💰",
    },
    {
  ...
  const handleEnrollClick = (e) => {
    ...
    // Loading state will persist until page actually changes
  };
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Fill a simple form and join the Smart Buy Plan
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 bg-gold-100 dark:bg-gold-900/30 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Select a monthly advance payment amount (starts from Rs.
                      5,000)
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Receive a Customer Receipt Book to track all payments
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 bg-gold-100 dark:bg-gold-900/30 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Buy jewelry of your choice with no wastage up to 16% after
                      12 months
                    </p>
                  </div>
                </div>
          ...
          >
            <Card className="p-6 bg-gradient-to-br from-gold-50 to-white dark:from-gray-900 dark:to-black border-gold-200 dark:border-gold-800">
              <h4 className="text-xl font-bold text-gold-600 dark:text-gold-400 mb-4">
                Example Plan (Rs. 5,000/month)
              </h4>
              <div className="space-y-3">
                {planExample.map((item, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center py-2 border-b border-gold-100 dark:border-gold-800/50 last:border-b-0"
                  >
        ...
        >
          {benefits.map((benefit, index) => (
            <Card
              key={index}
              className="p-6 text-center hover:shadow-lg transition-all duration-300 bg-white/80 dark:bg-black/90 dark:border-gold-600 border-gold-200 group hover:scale-105"
            >
