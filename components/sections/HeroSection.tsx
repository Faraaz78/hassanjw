          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute top-1/4 right-1/4 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full shadow-lg"
              />
              <motion.div
                animate={{
                  y: [0, 15, 0],
                ...
                className="absolute bottom-1/3 left-1/4 w-4 h-4 bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-full shadow-md"
              />
              <motion.div
                animate={{
                  x: [0, 10, -10, 0],
              ...
              <motion.div
                ...
                className="absolute top-3/4 left-1/3 w-5 h-5 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full shadow-lg opacity-50"
              />
            </motion.div>
          </div>
        </div>
