  ...
  const faqs = [
    {
      ...
      answer:
        "Advance payment should reach Hassan Jewellers before the 14th of every month. Payment can be made by Cash/Debit/Credit cards, NEFT/RTGS/UPI.",
    },
    {
      question: "What if I discontinue the plan early?",
      answer:
        "If you discontinue within 6 months, you won't be eligible for wastage discount and can only redeem accumulated value with 100% wastage. 8th-9th month: 60% discount on wastage. 10th month: 80% discount on wastage. 11th month: No wastage up to 16%.",
    },
    {
      question: "What if I don't pay continuously?",
      answer:
        "The plan will be discontinued automatically if you default on monthly payments. Continuous payments are essential to maintain eligibility for benefits.",
    },
    {
      question: "Can I buy jewelry exceeding my advance payment?",
      answer:
        "Yes, but wastage charges will apply on the excess amount. No wastage benefit applies only to the accumulated value amount.",
    },
    {
      question: "Will the cash be refunded?",
      answer:
        "No, cash will not be refunded under any circumstances, as per Government regulations.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can purchase gold coins without wastage and making charges.",
    },
  ];
            ...
            <div className="container mx-auto max-w-7xl">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
                  Save now and buy gold jewelry/articles with our Smart Buy
                  Plan. Choose from a wide range of gold jewelry and enroll
                  today to buy in 12 months from the date of enrollment.
                </p>
              </motion.div>
            </div>
          </section>
            ...
            <div className="container mx-auto max-w-7xl">
              ...
              >
                ...
                <p className="text-center text-gray-600 dark:text-gray-300 mb-12">
                  Select a monthly advance payment amount that works best for
                  you
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {planExamples.map((plan, index) => (
                    <Card
                      key={index}
                      className="p-6 text-center bg-gradient-to-br from-white to-gold-50 dark:from-gray-900 dark:to-black border-gold-200 dark:border-gold-800 hover:shadow-xl transition-all duration-300 hover:scale-105"
                    >
              ...
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                  {monthlyBreakdown.map((item, index) => (
                    <Card
                      key={index}
                      className="p-4 bg-white dark:bg-black border-gold-200 dark:border-gold-800"
                    >
                ...
                <Card className="p-6 bg-gradient-to-r from-gold-100 to-gold-200 dark:from-gold-900/30 dark:to-gold-800/30 border-gold-300 dark:border-gold-700">
                  <div className="text-center">
                    ...
                    <p className="text-gold-600 dark:text-gold-400">
                      With ₹60,000 accumulated value and gold rate at ₹6,600 per
                      gram, you'll be eligible for
                      <span className="font-bold">
                        {" "}
                        9.090 grams of gold jewelry with no wastage up to 16%
                      </span>
                    </p>
                    <p className="text-sm text-gold-500 dark:text-gold-500 mt-2">
                      *Government taxes and other levies applicable at the time
                      of purchase
                    </p>
                  </div>
                </Card>
              ...
              >
                ...
                <div className="space-y-6">
                  {faqs.map((faq, index) => (
                    <Card
                      key={index}
                      className="p-6 bg-white dark:bg-black border-gold-200 dark:border-gold-800"
                    >
                    ...
                    {termsConditions.map((term, index) => (
                      <div key={index} className="flex items-start space-x-3">
                        <span className="w-6 h-6 bg-gold-100 dark:bg-gold-900/30 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span className="text-gold-600 dark:text-gold-400 font-bold text-xs">
                            {index + 1}
                          </span>
                        </span>
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      hassanjewellers.office@gmail.com
                    </p>
                  </div>
                  <div className="text-center">
